...
// MOUSE
    function tapMouseDown(e) {
        ...
        if (tapEnabledTouchEvents) {
            ...
            if (!ionic.Platform.isEdge() && (!ionic.tap.isTextInput(e.target) || tapLastTouchTarget !== e.target) && !isSelectOrOption(e.target.tagName) && !e.target.isContentEditable && !ionic.tap.isVideo(e.target)) {
